...
def evaluate_board(board):
    ...
    # THESE 2 ARE NOT IMPLEMENTED YET
    W_positional = 0.3  
    W_mobility = 0.2    
    ...
    PASSED_PAWN_VALUE = 0.5 #this is the bonus for having a passed pawn (cannot be stopped from promoting) - TODO: Not yet used
    DOUBLED_PAWN_PENALTY = 0.2 #penalty for having 2 pawns on the same file (cannot defend eachother) - TODO: Not yet used
    ...
    black_pawn_structure_score = pawn_metrics(board, chess.BLACK, PASSED_PAWN_VALUE, DOUBLED_PAWN_PENALTY, ISOLATED_PAWN_PENALTY)
